...
// import { formatDate, formatTime } from "constants/lib/"
import { Ride } from "types/type";
import { formatDate, formatTime } from "constants/lib/utils";


const RideCard = ({ ride ,index}: { ride: Ride,index:number }) => {
  return (
    <View key={index} className="flex flex-row items-center justify-center bg-white rounded-lg shadow-sm shadow-neutral-300 mb-3">
      <View className=" flex flex-col items-start justify-center p-3">
        ...
        <View className="flex flex-col w-full  mt-5 bg-general-500 rounded-lg p-3 items-center justify-center">
          ...
          <View className="flex flex-row items-center w-full justify-between mb-5">
             ...
             <Text className={`text-md font-JakartaBold capitalize ${ride.payment_status == "paid" ?  "text-green-500":"text-red-500"}`}>
              {ride.payment_status}
             </Text>
          </View>
        </View>
